...
#define GPIOA_PIN1		  GPIO_UNINIT
#define GPIOA_PIN1_MODE 		INPUT_FLOATING


#define GPIOA_PIN2		  GPIO_UNINIT
#define GPIOA_PIN2_MODE 		INPUT_FLOATING


#define GPIOA_PIN3		  GPIO_UNINIT
#define GPIOA_PIN3_MODE 		INPUT_FLOATING


#define GPIOA_PIN4		  GPIO_UNINIT
#define GPIOA_PIN4_MODE 		INPUT_FLOATING
...
#define GPIOA_PIN9			GPIO_UNINIT
#define GPIOA_PIN9_MODE 		INPUT_FLOATING


#define GPIOA_PIN10			GPIO_UNINIT
...
#define GPIOB_PIN13		GPIO_UNINIT
