...
void Uart_SendChar(uint8_t UART_x, uint16_t Data)
{
...
void Uart_PrintString(uint8_t UART_x ,uint8_t* string)
{
	uint8_t i = 0;
...
/**
  ...
  * @retval None
  */
void Uart_PrintHexNumber(uint8_t UART_x ,uint16_t Hex_number)
{
	/* counter variable */
	uint8_t i = 0;
