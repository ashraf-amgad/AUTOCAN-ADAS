...
void Gpio_SetPinValue(GPIO_TypeDef *PORT, uint16_t PIN_NUMBER, uint8_t STATE){
...
uint8_t Gpio_GetPinValue( GPIO_TypeDef * PORT ,uint16_t PIN_NUMBER)
{
	uint16_t state;
...
/**
  * @brief  function to togle Pin
  * @param  uint16_t Delay_Time						delay time to togle the led 							
	* @param  uint8_t counts								how many times you want to togle the led
	* @param  GPIO_TypeDef *port		which port you want to read its pin
	*					i.e										GPIOA ,GPIOB and GPIOC. 							
	* @param  uint8_t pin						which pin of the port you want to read 
	*					i.e										GPIO_PIN_0 ,GPIO_PIN_1 ...GPIO_PIN_15
...
//		{
//			/* SET Pin */ 
//			GPIO_voidSetPinValue(PORT ,PIN_NUMBER ,GPIO_SET);
//			
//			/* wait for the delay time */
//			Delay(Delay_Time);
//			
//			/* RESET Pin */ 
//			GPIO_voidSetPinValue(PORT ,PIN_NUMBER ,GPIO_RESET);
//			
//			/* wait for the delay time */
//			Delay(Delay_Time);
//			
